...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.16\textwidth} p{0.19\textwidth} p{0.19\textwidth} p{0.19\textwidth} p{0.19\textwidth}}
        ...
        \midrule
        \texttt{international} & \textbf{待填} & \textbf{待填} & \textbf{待填} & \textbf{待填} \\
        \texttt{artificial\_intelligence} & \textbf{待填} & \textbf{待填} & \textbf{待填} & \textbf{待填} \\
        \texttt{人工智能} & \textbf{待填} & \textbf{待填} & \textbf{待填} & \textbf{待填} \\
        \texttt{China-US} & \textbf{待填} & \textbf{待填} & \textbf{待填} & \textbf{待填} \\
        \bottomrule
    \end{tabular}
\end{table}
