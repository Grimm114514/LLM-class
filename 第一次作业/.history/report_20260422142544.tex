...
对于中文数据，主要任务就是去掉词性标注，如处理像 [中国/ns 人民/n]nt 这种，将其转换为 [中国 人民]，对于英文数据，主要任务就是将文本中的英文单词和标点符号分开，如处理像 "This is a test." 这种，将其转换为 "This is a test ."，以保证 BPE 过程中不会出现跨词合并的情况。
