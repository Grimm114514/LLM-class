...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.2\textwidth} p{0.56\textwidth} p{0.14\textwidth}}
        ...
        \midrule
        \texttt{en6400.json} & [2430, 245, 1014, 32] & 4 \\
        \texttt{en16000.json} & [2430, 245, 1014, 32] & 4 \\
        \texttt{mix6400.json} & [39, 4082, 3917, 5614, 31] & 5 \\
        \texttt{mix16000.json} & [8410, 3917, 5614, 31] & 4 \\
        \bottomrule
    \end{tabular}
