...
TRAIN_CORPUS_PATH = DATA_DIR / "train_corpus.txt"
TOKENIZER_PATH = DATA_DIR / "bpe_tokenizer.json"
VOCAB_TXT_PATH = DATA_DIR / "bpe_vocab.txt"

SOURCE_FILES = [
    DATA_DIR / "2020-40_zh_head_0001.jsonl",
    DATA_DIR / "corpus_cleaned_keep_punc.txt",
    DATA_DIR / "wikipedia-cn-20230720-filtered.json",
]
